...
Build.import(%i[user_id slug title total_price cpu_type price_showed provider_showed created_at updated_at], [
...
Comment.import(%i[user_id build_id content created_at updated_at], [
