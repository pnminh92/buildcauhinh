...
app_path = '/var/www/buildcauhinh.com/public_html'
...
# The default is "0, 16".
#
threads ENV.fetch('BUILDCAUHINH_MIN_THREAD') { 0 }, ENV.fetch('BUILDCAUHINH_MAX_THREAD') { 16 }
...
# The default is "0".
#
workers ENV.fetch('BUILDCAUHINH_WORKERS') { 2 }
